...
<link rel="stylesheet" id="login-css" href="https://drdevnayar.github.io/sriherobgyn/wp-admin/css/login.min.css?ver=5.8" media="all">
	...
	<script type="text/javascript">
		...
		<form name="loginform" id="loginform" action="localhost/sriherobgyn/wp-login.php" method="post">
			<p>
			...
			<p class="submit">
				<input type="submit" name="wp-submit" id="wp-submit" class="button button-primary button-large" value="Log In">
									<input type="hidden" name="redirect_to" value="localhost/sriherobgyn/wp-admin/">
